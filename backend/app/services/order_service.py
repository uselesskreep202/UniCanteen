...
class OrderService:
    ...
    def create_order(self, user_id: int, data: OrderCreate):
        ...
        return self.order_repo.create_order(user_id=user_id, slot_id=data.slot_id,
            total_price=round(total, 2), notes=data.notes, items_data=items_data)
    ...
    def get_stats(self):
        ...
        return {
            ...
            "revenue": round(sum(o.total_price for o in orders if o.status == OrderStatus.COMPLETED), 2),
        }